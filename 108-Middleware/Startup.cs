...
namespace Middleware
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
           ...
           //    app.Run(async context => Console.WriteLine("Middleware 2."));//Run() kısa devre bir middleware olduğundan Middleware 2. yi yazmaz.Middleware1. yazar sonraki işlemleri gerçekleştirmez.

           //app.Use()
        //    app.Use(async (context,next) => {
        //       Console.WriteLine("Middleware 1 başladı.");
        //       await next.Invoke();//Bir sonraki middleware'i tetiklediki
        ...
        //    });
          ...
          app.UseHello();
           ...
           //app.Map():Route'a göre middleware'i yönlendrimemize yarar.
           app.Map("/example",internalApp=>
           internalApp.Run(async context=> 
           {
               Console.WriteLine("/example middleware tetiklendi!");
               await context.Response.WriteAsync("/example middleware tetiklendi!");//context içerisindeki response mesaj yazdık.
           }));
           ...
           internalApp.Run(async context => {
              ...
              context.Response.WriteAsync("mapWhen middleware tetiklendi!");
           });
           });
